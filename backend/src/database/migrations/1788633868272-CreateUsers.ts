...
export class CreateUsers1788633868272 implements MigrationInterface {
    name = 'CreateUsers1788633868272'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."users_role_enum" AS ENUM('STUDENT', 'FACULTY', 'ADMIN')`);
